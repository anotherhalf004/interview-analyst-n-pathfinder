 ...
 * @description Register new user , expects username , email and password
 * @access public
 */
...
async function registerUserController(req,res) {
    ...
    if(isUserAlreadyExists){
        return res.status(400).json({
            message : 'Account alraeady exists'
        })
    }
 ...
 * @description login a user , expects email and passsword in req body
 * @access public
 */
